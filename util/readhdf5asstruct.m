...
% readhdf5asstruct    Read an HDF5 file and convert it to a Matlab structure
%
...
%   info : < 1x1 struct > Information about the HDF5 file (output of `hdf5info(hdf5Path)`)
%
% Example:
%
%     [ data, info ] = readHDF5AsStruct('sampleData.hdf5')
%
%
